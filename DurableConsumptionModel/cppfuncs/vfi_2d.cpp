...
double value_of_choice(int t, double c, double d1, double d2, double p, double x, sol_struct *sol, par_struct *par)
{
...
double obj_keep_gs(double c, void *solver_data_in)
{
    ...
    return -value_of_choice(t,c,d1,d2,p,x,sol,par);
...
double obj_keep(unsigned n, const double *choices, double *grad, void *solver_data_in)
{
    ...
    // value of choice
    double obj = -value_of_choice(t,c,d1,d2,p,x,sol,par);

    // gradient
    if(grad){
        double forward = -value_of_choice(t,c+EPS,d1,d2,p,x,sol,par);
...
double obj_adj_full(unsigned n, const double *choices, double *grad, void *solver_data_in)
{
    ...
    // gradient
    if(grad){
        double forward_d1 = -value_of_choice(t,c,d1+EPS,d2,p,x,sol,par);
        grad[0] = (forward_d1 - obj)/EPS;
        double forward_d2 = -value_of_choice(t,c,d1,d2+EPS,p,x,sol,par);
        grad[1] = (forward_d2 - obj)/EPS;        
        double forward_c = -value_of_choice(t,c+EPS,d1,d2,p,x,sol,par);
...
double obj_adj_d1(unsigned n, const double *choices, double *grad, void *solver_data_in)
{
...
double obj_adj_d2(unsigned n, const double *choices, double *grad, void *solver_data_in)
{
...
double ineq_con_adj_full(unsigned n, const double *choices, double *grad, void *solver_data_in)
{
...
double ineq_con_adj_d1(unsigned n, const double *choices, double *grad, void *solver_data_in)
{
...
double ineq_con_adj_d2(unsigned n, const double *choices, double *grad, void *solver_data_in)
{
...
EXPORT void solve_adj_full(par_struct *par, sol_struct *sol, sim_struct *sim)
{
    ...
    auto opt = nlopt_create(NLOPT_LD_MMA, 3);
        ...
        // settings
        nlopt_set_min_objective(opt, obj_adj_full, solver_data);
        nlopt_set_xtol_rel(opt, 1e-6);
        nlopt_set_maxeval(opt, 200);

        // constraints
        nlopt_add_inequality_constraint(opt, ineq_con_adj_full, solver_data, 1e-8);
...
EXPORT void solve_adj_d1(par_struct *par, sol_struct *sol, sim_struct *sim)
{
    ...
    auto opt = nlopt_create(NLOPT_LD_MMA, 2);
        ...
        // settings
        nlopt_set_min_objective(opt, obj_adj_d1, solver_data);
        nlopt_set_xtol_rel(opt, 1e-6);
        nlopt_set_maxeval(opt, 200);

        // constraints
        nlopt_add_inequality_constraint(opt, ineq_con_adj_d1, solver_data, 1e-8);
...
EXPORT void solve_adj_d2(par_struct *par, sol_struct *sol, sim_struct *sim)
{
    ...
    auto opt = nlopt_create(NLOPT_LD_MMA, 2);
        ...
        // settings
        nlopt_set_min_objective(opt, obj_adj_d2, solver_data);
        nlopt_set_xtol_rel(opt, 1e-6);
        nlopt_set_maxeval(opt, 200);

        // constraints
        nlopt_add_inequality_constraint(opt, ineq_con_adj_d2, solver_data, 1e-8);
